...
export const demoTasks: WorkItem[] = [
  ...
  { id: "demo-2", source: "github", type: "bug", title: "缺少設定檔時 CLI 仍回傳成功狀態", description: "找不到設定檔時，CLI 應回傳非零的結束代碼。", acceptance_criteria: null, review_status: "pending", planning_status: "draft", agent_status: "idle", github_issue_number: 51, github_issue_url: "https://github.com/example/repo/issues/51", notion_page_url: null, updated_at: new Date().toISOString() }
];
