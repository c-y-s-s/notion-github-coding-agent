...
export default function RetrievalEvaluationPage() {
  ...
  return <>
    <div className="eyebrow">Context Retrieval</div><h1>Retrieval Evaluation</h1><p className="lead">在相同 Dataset、相同 Ground Truth 與相同 K 下，比較 Keyword 與 Hybrid Semantic Retrieval。</p>
    ...
    <section className="section card limitation-card"><h2>限制與正確解讀</h2><ul className="analysis-list">{report.limitations.map(item => <li key={item}>{item}</li>)}<li>目前不能宣稱 Hybrid 優於 Keyword；下一版需加入更多干擾檔案與同義描述案例。</li></ul></section>
